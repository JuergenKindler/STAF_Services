...
public interface Constants {
	...
	public static final String T_VIRTUAL_MACHINE_ID = "VirtualMachineID";
	public static final String T_DISPLAY_NAME = "Display name";
	public static final String T_PROVIDER = "Attached provider";
	public static final String T_MBEAN_OBJECT = "MBean Object";
